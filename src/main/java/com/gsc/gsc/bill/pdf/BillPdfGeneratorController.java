...
@Controller
public class BillPdfGeneratorController {

    @Autowired
    BillPdfGeneratorITextService billPdfGeneratorITextService;

    @GetMapping("/pdf2/{billId}")
    public ResponseEntity<ReturnObject> generateJobCardPdfIText(@RequestHeader("Authorization") String token, @PathVariable int billId, @RequestParam String macAddress,
